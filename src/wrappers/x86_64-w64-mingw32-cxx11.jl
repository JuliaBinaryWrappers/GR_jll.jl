# Autogenerated wrapper script for GR_jll for x86_64-w64-mingw32-cxx11
...
const gksqt_splitpath = ["bin", "gksqt.exe"]
...
const libGKS_splitpath = ["bin", "libGKS.dll"]
...
const libGKS = "libGKS.dll"


# Relative path to `libGR`
const libGR_splitpath = ["bin", "libGR.dll"]
...
const libGR3_splitpath = ["bin", "libGR3.dll"]
...
const libGRM_splitpath = ["bin", "libGRM.dll"]
