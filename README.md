...
This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl). The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c329b802c1e29df253d642c103fa5aa354d73ac3/G/GR/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.  If you have any issue, please report it to the Yggdrasil [bug tracker](https://github.com/JuliaPackaging/Yggdrasil/issues).
...
* git repository: https://github.com/sciapp/gr.git (revision: `95600ad51830588f2a8ad5d600b1490a5847c10a`)
* file: https://github.com/sciapp/gr/releases/download/v0.57.1/gr-0.57.1.js (SHA256 checksum: `e5933b240a4caa9eeeb41f0945de4fac38a860d9b03d409ba6f8b4bcfbffa5c7`)
